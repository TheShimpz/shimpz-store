...
const EN: InstitutionalContent = {
  ...
  title: "Finally, delegate real work without giving up control.",
  ...
  support: "AI understands and coordinates. Declared Powers execute the work instead of rebuilding the solution from scratch for every task.",
  ...
  alternatives: [
    { title: "Stop building every flow", body: "State the objective instead of wiring connectors, webhooks, credentials, and branches for every new task." },
    { title: "Stop trusting every improvisation", body: "Assistants expose programmed Powers. The Team admits what may run and returns sensitive decisions to you." },
  ],
  ...
  github: "Open GitHub",
  finalKicker: "Shimpz // Local",
  finalTitle: "Give your first Team a place to work.",
  finalBody: "Install a Local Space, open Shimpz Admin, configure inference, and choose the Assistants your Team can use.",
...
const CONTENT: Record<Locale, InstitutionalContent> = {
  ...
  pt: {
    ...
    title: "Finalmente, delegue trabalho real sem abrir mão do controle.",
    ...
    support: "A IA compreende e coordena. Powers declarados executam o trabalho sem reconstruir a solução do zero para cada tarefa.",
    ...
    alternatives: [
      { title: "Pare de construir cada fluxo", body: "Declare o objetivo em vez de ligar conectores, webhooks, credenciais e desvios para cada tarefa nova." },
      { title: "Pare de confiar em cada improviso", body: "Assistentes expõem Powers programados. O Time admite o que pode rodar e devolve as decisões sensíveis a você." },
    ],
    ...
    github: "Abrir GitHub",
    finalKicker: "Shimpz // Local",
    finalTitle: "Dê ao seu primeiro Time um lugar para trabalhar.",
    finalBody: "Instale um Space Local, abra o Shimpz Admin, configure a inferência e escolha os Assistentes que seu Time pode usar.",
  ...
  es: {
    ...
    title: "Por fin, delega trabajo real sin renunciar al control.",
    ...
    support: "La IA comprende y coordina. Los Powers declarados ejecutan el trabajo sin reconstruir la solución desde cero para cada tarea.",
    ...
    alternatives: [{ title: "Deja de construir cada flujo", body: "Expresa el objetivo en lugar de conectar integraciones, webhooks, credenciales y ramas para cada tarea nueva." }, { title: "Deja de confiar en cada improvisación", body: "Los Asistentes exponen Powers programados. El Team admite lo que puede ejecutarse y te devuelve las decisiones sensibles." }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "Dale a tu primer Team un lugar para trabajar.", finalBody: "Instala un Space Local, abre Shimpz Admin, configura la inferencia y elige los Asistentes que tu Team puede usar.", assistantsLink: "Explorar Asistentes", documentation: "Leer la documentación",
  },
  fr: {
    ...
    eyebrow: "Organisation open source · autorité humaine", title: "Enfin, déléguez du vrai travail sans renoncer au contrôle.", lead: "Parlez à votre Team. Installez des Assistants qui lui apportent des capacités programmées. Autorisez les actions sensibles et inspectez le résultat.", support: "L’IA comprend et coordonne. Des Powers déclarés exécutent le travail sans reconstruire la solution à chaque tâche.",
    ...
    problemKicker: "Une autre limite // moins d’assemblage, moins d’improvisation", problemTitle: "L’automatisation ne devrait pas créer plus de travail.", problemLead: "Shimpz se place entre les outils de workflow que vous devez construire et les agents généralistes que vous devez surveiller sans cesse.", alternatives: [{ title: "Ne construisez plus chaque workflow", body: "Exprimez l’objectif au lieu d’assembler connecteurs, webhooks, identifiants et branches pour chaque tâche." }, { title: "Ne faites plus confiance à chaque improvisation", body: "Les Assistants exposent des Powers programmés. La Team admet ce qui peut s’exécuter et vous rend les décisions sensibles." }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "Donnez à votre première Team un espace de travail.", finalBody: "Installez un Space Local, ouvrez Shimpz Admin, configurez l’inférence et choisissez les Assistants de votre Team.", assistantsLink: "Explorer les Assistants", documentation: "Lire la documentation",
  },
  de: {
    seoTitle: "Shimpz — echte digitale Arbeit delegieren, ohne Kontrolle abzugeben", seoDescription: "Sprich mit einem Team, installiere programmierte Assistants, genehmige sensible Aktionen und betreibe Shimpz auf eigener Infrastruktur.", eyebrow: "Open-Source-Organisation · menschliche Autorität", title: "Endlich echte Arbeit delegieren, ohne die Kontrolle abzugeben.", lead: "Sprich mit deinem Team. Installiere Assistants mit programmierten Fähigkeiten. Genehmige sensible Aktionen und prüfe das Ergebnis.", support: "KI versteht und koordiniert. Deklarierte Powers führen die Arbeit aus, statt die Lösung für jede Aufgabe neu zu bauen.",
    installKicker: "Local Space // kanonischer Installer", installTitle: "Starte auf der Infrastruktur, die du kontrollierst.", installBody: "Erstelle mit dem kanonischen Installer einen Local Space. Dieselbe Produktsprache gilt für das von Shimpz betriebene Hosted-Profil.", problemKicker: "Eine andere Grenze // weniger Aufbau, weniger Improvisation", problemTitle: "Automatisierung sollte nicht mehr Arbeit erzeugen.", problemLead: "Shimpz liegt zwischen Workflow-Tools, die du konstruieren musst, und allgemeinen Agenten, die du ständig überwachen musst.", alternatives: [{ title: "Baue nicht jeden Ablauf selbst", body: "Nenne das Ziel, statt für jede Aufgabe Konnektoren, Webhooks, Zugangsdaten und Verzweigungen zu verdrahten." }, { title: "Vertraue nicht jeder Improvisation", body: "Assistants stellen programmierte Powers bereit. Das Team lässt nur zu, was ausgeführt werden darf, und gibt dir sensible Entscheidungen zurück." }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "Gib deinem ersten Team einen Arbeitsplatz.", finalBody: "Installiere einen Local Space, öffne Shimpz Admin, konfiguriere Inferenz und wähle die Assistants deines Teams.", assistantsLink: "Assistants entdecken", documentation: "Dokumentation lesen",
  },
  zh: {
    seoTitle: "Shimpz — 委派真实的数字工作，同时保留控制权", seoDescription: "与 Team 对话，安装具有既定能力的 Assistant，授权敏感操作，并在你控制的基础设施上运行 Shimpz。", eyebrow: "开源组织 · 人类授权", title: "终于，可以委派真实工作，而不必交出控制权。", lead: "与你的 Team 对话。安装为它提供既定能力的 Assistant。授权敏感操作，并检查实际发生了什么。", support: "AI 负责理解与协调。声明过的 Power 执行工作，无需为每项任务从头重建解决方案。",
    installKicker: "Local Space // 标准安装程序", installTitle: "从你控制的基础设施开始。", installBody: "使用标准安装程序创建 Local Space。由 Shimpz 运营的 Hosted 配置使用相同的产品语言。", problemKicker: "不同的边界 // 少搭建，少即兴", problemTitle: "自动化不应制造更多工作。", problemLead: "Shimpz 位于两者之间：一边是需要你设计的工作流工具，另一边是需要你持续监督的通用 Agent。", alternatives: [{ title: "不再搭建每个流程", body: "直接说明目标，而不是为每项新任务连接组件、Webhook、凭据和分支。" }, { title: "不再信任每次即兴执行", body: "Assistant 提供编程实现的 Power。Team 决定什么可以运行，并把敏感决策交还给你。" }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "为你的第一个 Team 提供工作空间。", finalBody: "安装 Local Space，打开 Shimpz Admin，配置推理，并选择 Team 可以使用的 Assistant。", assistantsLink: "浏览 Assistant", documentation: "阅读文档",
  },
  ja: {
    seoTitle: "Shimpz — 制御を手放さずに、現実のデジタル作業を任せる", seoDescription: "Team と対話し、プログラムされた Assistant を導入し、重要な操作を承認して、管理するインフラで Shimpz を実行できます。", eyebrow: "オープンソース組織 · 人の権限", title: "ついに、制御を手放さずに本当の仕事を任せられる。", lead: "Team と話し、プログラムされた能力を持つ Assistant を導入します。重要な操作を承認し、何が起きたか確認できます。", support: "AI は理解と調整を担います。宣言済みの Power が実行するため、タスクごとに解決策をゼロから作り直しません。",
    installKicker: "Local Space // 正規インストーラー", installTitle: "自分が管理するインフラから始める。", installBody: "正規インストーラーで Local Space を作成します。Shimpz が運用する Hosted プロファイルにも同じ製品言語が適用されます。", problemKicker: "異なる境界 // 組み立ても即興も少なく", problemTitle: "自動化が仕事を増やすべきではありません。", problemLead: "Shimpz は、自分で設計するワークフローツールと、常に監視が必要な汎用 Agent の間に位置します。", alternatives: [{ title: "フローを毎回作らない", body: "新しいタスクごとにコネクタ、Webhook、認証情報、分岐を組む代わりに、目的を伝えます。" }, { title: "即興の実行を信じ切らない", body: "Assistant はプログラムされた Power を公開します。Team が実行可能なものを認め、重要な判断をあなたに返します。" }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "最初の Team に働く場所を用意する。", finalBody: "Local Space をインストールし、Shimpz Admin を開き、推論を設定して Team が使う Assistant を選びます。", assistantsLink: "Assistant を見る", documentation: "ドキュメントを読む",
  },
  ar: {
    seoTitle: "Shimpz — فوّض العمل الرقمي الحقيقي دون التخلي عن التحكم", seoDescription: "تحدث مع Team وثبّت Assistants مبرمجة ووافق على الإجراءات الحساسة وشغّل Shimpz على بنيتك التحتية.", eyebrow: "منظمة مفتوحة المصدر · سلطة بشرية", title: "أخيرًا، فوّض العمل الحقيقي دون أن تتخلى عن التحكم.", lead: "تحدث مع Team الخاصة بك. ثبّت Assistants تمنحها قدرات مبرمجة. وافق على الإجراءات الحساسة وافحص ما حدث.", support: "يفهم الذكاء الاصطناعي وينسّق. تنفذ Powers المعلنة العمل بدل إعادة بناء الحل من الصفر لكل مهمة.",
    installKicker: "Space محلية // المثبّت المعتمد", installTitle: "ابدأ على البنية التحتية التي تتحكم بها.", installBody: "أنشئ Space محلية بالمثبّت المعتمد. تنطبق لغة المنتج نفسها على ملف Hosted الذي تديره Shimpz.", problemKicker: "حد مختلف // تركيب أقل وارتجال أقل", problemTitle: "ينبغي ألا تنشئ الأتمتة مزيدًا من العمل.", problemLead: "تقع Shimpz بين أدوات سير العمل التي يجب أن تبنيها والوكلاء العامين الذين يجب أن تراقبهم باستمرار.", alternatives: [{ title: "توقف عن بناء كل تدفق", body: "اذكر الهدف بدل توصيل الموصلات وwebhooks وبيانات الاعتماد والفروع لكل مهمة جديدة." }, { title: "لا تثق بكل ارتجال", body: "تعرض Assistants قدرات Powers مبرمجة. تقرر Team ما يمكن تشغيله وتعيد إليك القرارات الحساسة." }],
    ...
    finalKicker: "Shimpz // Local", finalTitle: "امنح Team الأولى مكانًا للعمل.", finalBody: "ثبّت Space محلية وافتح Shimpz Admin واضبط الاستدلال واختر Assistants التي يمكن لـ Team استخدامها.", assistantsLink: "استكشف Assistants", documentation: "اقرأ الوثائق",
  },
};
