...
const EN: InstitutionalContent = {
  ...
  title: "Finally, delegate without losing control.",
...
const CONTENT: Record<Locale, InstitutionalContent> = {
  ...
  pt: {
    ...
    title: "Finalmente, delegue sem perder o controle.",
  ...
  es: {
    ...
    title: "Por fin, delega sin perder el control.",
  ...
  fr: {
    ...
    eyebrow: "Organisation open source · autorité humaine", title: "Enfin, déléguez sans perdre le contrôle.", lead: "Parlez à votre Team. Installez des Assistants qui lui apportent des capacités programmées. Autorisez les actions sensibles et inspectez le résultat.",
  ...
  zh: {
    seoTitle: "Shimpz — 委派真实的数字工作，同时保留控制权", seoDescription: "与 Team 对话，安装具有既定能力的 Assistant，授权敏感操作，并在你控制的基础设施上运行 Shimpz。", eyebrow: "开源组织 · 人类授权", title: "终于，可以委派工作而不失去掌控。", lead: "与你的 Team 对话。安装为它提供既定能力的 Assistant。授权敏感操作，并检查实际发生了什么。",
  ...
  ja: {
    seoTitle: "Shimpz — 制御を手放さずに、現実のデジタル作業を任せる", seoDescription: "Team と対話し、プログラムされた Assistant を導入し、重要な操作を承認して、管理するインフラで Shimpz を実行できます。", eyebrow: "オープンソース組織 · 人の権限", title: "ついに、主導権を保ったまま任せられる。", lead: "Team と話し、プログラムされた能力を持つ Assistant を導入します。重要な操作を承認し、何が起きたか確認できます。",
