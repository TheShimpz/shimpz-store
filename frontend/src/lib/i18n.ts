...
const D: Dict = {
  ...
  human_approval_kicker: { en: "Power // approval", pt: "Power // aprovação" },
  human_input_kicker: { en: "Power // input", pt: "Power // entrada" },
  human_auth_kicker: { en: "Power // sensitive authorization", pt: "Power // autorização sensível" },
  human_paused: {
    en: "The Power is paused. Nothing continues until you decide.",
    pt: "O Power está pausado. Nada continua até você decidir.",
  },
  human_expires: { en: "Expires in", pt: "Expira em" },
  human_seconds: { en: "seconds", pt: "segundos" },
  human_assistant: { en: "Assistant", pt: "Assistant" },
  human_power: { en: "Power", pt: "Power" },
  human_required: { en: "Required", pt: "Obrigatório" },
  human_optional: { en: "Optional", pt: "Opcional" },
  human_choose: { en: "Choose an option", pt: "Escolha uma opção" },
  ...
  human_password_label: { en: "Current password", pt: "Senha atual" },
  human_totp_label: { en: "Authenticator code", pt: "Código do autenticador" },
  human_totp_placeholder: { en: "6-digit code", pt: "Código de 6 dígitos" },
  ...
  human_cancel: { en: "Deny and stop", pt: "Negar e interromper" },
  human_approve: { en: "Approve once", pt: "Aprovar uma vez" },
  human_submit: { en: "Submit securely", pt: "Enviar com segurança" },
  human_authorize: { en: "Authorize once", pt: "Autorizar uma vez" },
  human_passkey: { en: "Use passkey", pt: "Usar passkey" },
