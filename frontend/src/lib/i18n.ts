...
const D: Dict = {
  ...
  human_context: {
    en: "Action {action} from {assistant} v{version} assistant needs human validation. Expires in {seconds} seconds.",
  ...
  human_auth_failed: { en: "Authentication was not confirmed. The Action was stopped.", pt: "A autenticação não foi confirmada. O Action foi interrompido." },
