...
const D: Dict = {
  ...
  home_privacy_line: { en: "Cloudflare adds an analytics tag; Shimpz blocks it from running.", pt: "A Cloudflare adiciona uma tag de analytics; o Shimpz impede sua execução.", es: "Cloudflare añade una etiqueta de analítica; Shimpz impide que se ejecute.", zh: "Cloudflare 会添加分析标签；Shimpz 会阻止它运行。", fr: "Cloudflare ajoute une balise d’analyse ; Shimpz bloque son exécution.", de: "Cloudflare fügt ein Analyse-Tag ein; Shimpz blockiert dessen Ausführung.", ja: "Cloudflare は分析タグを追加しますが、Shimpz はその実行をブロックします。", ar: "تضيف Cloudflare وسم تحليلات، ويحظر Shimpz تشغيله." },
