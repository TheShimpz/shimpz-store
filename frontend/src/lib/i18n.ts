...
const D: Dict = {
  ...
  home_privacy_line: { en: "Cloudflare Web Analytics measures performance without cookies or fingerprinting.", pt: "O Cloudflare Web Analytics mede o desempenho sem cookies nem fingerprinting.", es: "Cloudflare Web Analytics mide el rendimiento sin cookies ni fingerprinting.", zh: "Cloudflare Web Analytics 在不使用 Cookie 或浏览器指纹的情况下衡量性能。", fr: "Cloudflare Web Analytics mesure les performances sans cookies ni fingerprinting.", de: "Cloudflare Web Analytics misst die Leistung ohne Cookies oder Fingerprinting.", ja: "Cloudflare Web Analytics は Cookie やフィンガープリンティングを使わずにパフォーマンスを計測します。", ar: "يقيس Cloudflare Web Analytics الأداء من دون ملفات تعريف ارتباط أو بصمات رقمية." },
