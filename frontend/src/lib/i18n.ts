...
const D: Dict = {
  ...
  home_read_script: { en: "Read the script first", pt: "Leia o script primeiro", es: "Lee primero el script", zh: "先阅读脚本", fr: "Lisez d’abord le script", de: "Script zuerst lesen", ja: "先にスクリプトを読む", ar: "اقرأ النص البرمجي أولًا" },
