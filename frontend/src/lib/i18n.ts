...
const D: Dict = {
  ...
  chat_lead: {
    en: "Choose one installed Assistant. Its Rules and Powers bound every turn while the Capsule Brain remains only the inference provider.",
    pt: "Escolha um Assistant instalado. Seus Rules e Powers limitam cada turno, enquanto o Cérebro da Cápsula permanece apenas como provedor de inferência.",
  },
  ...
  chat_brain_help: {
    en: "The Brain is only the inference instrument. Every turn is bound to the selected installed Assistant and its declared Powers.",
    pt: "O Cérebro é apenas o instrumento de inferência. Cada turno fica restrito ao Assistant instalado selecionado e aos seus Powers declarados.",
  },
  ...
  chat_assistants_help: {
    en: "Select the installed Assistant for this conversation. Only its declared Powers are available to the Brain.",
    pt: "Selecione o Assistant instalado para esta conversa. Apenas os Powers declarados por ele ficam disponíveis ao Cérebro.",
  },
  ...
  chat_assistant_target: { en: "Selected Assistant", pt: "Assistant selecionado" },
  chat_choose_assistant: { en: "Choose an Assistant", pt: "Escolha um Assistant" },
  chat_choose_assistant_help: {
    en: "Choose a running installed Assistant to start. The Brain cannot act outside that Assistant's Rules and Powers.",
    pt: "Escolha um Assistant instalado e em execução para começar. O Cérebro não pode agir fora dos Rules e Powers desse Assistant.",
  },
  ...
  chat_placeholder: { en: "Message the selected Assistant…", pt: "Envie uma mensagem ao Assistant selecionado…" },
  chat_send: { en: "Send", pt: "Enviar" },
  chat_thinking: { en: "the Assistant is reasoning…", pt: "o Assistant está raciocinando…" },
  ...
  chat_protocol_error: {
    en: "The Capsule returned an invalid chat response. The turn was stopped safely.",
    pt: "A Cápsula retornou uma resposta de chat inválida. O turno foi parado com segurança.",
  },
  chat_thread_label: { en: "Conversation with the selected Assistant", pt: "Conversa com o Assistant selecionado" },
  chat_attach: { en: "Store a Capsule file", pt: "Armazenar arquivo na Cápsula" },
  chat_file_ok: { en: "Stored in Capsule storage:", pt: "Armazenado na Cápsula:" },
  chat_file_boundary: {
  ...
  chat_storage_help: {
    en: "Opaque Capsule storage. Files are never executable or mounted into a Brain or Assistant; a declared Power must request access.",
    pt: "Storage opaco da Cápsula. Arquivos nunca são executáveis nem montados em um Cérebro ou Assistant; um Power declarado precisa solicitar acesso.",
  },
  chat_storage_free: { en: "free", pt: "livres" },
  chat_storage_empty: { en: "No files stored in this Capsule.", pt: "Nenhum arquivo armazenado nesta Cápsula." },
  chat_empty: {
    en: "Start with a goal or question for the selected Assistant. Stored files remain private until a Power explicitly uses one.",
    pt: "Comece com um objetivo ou pergunta para o Assistant selecionado. Arquivos armazenados permanecem privados até um Power usar um deles explicitamente.",
  },
