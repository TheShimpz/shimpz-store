...
const D: Dict = {
  ...
  caps_login: { en: "Sign in to see your Teams.", pt: "Entre para ver seus Times." },
  caps_none: { en: "No Teams yet — create one to get started.", pt: "Nenhum Time ainda — crie um para começar." },
  caps_new: { en: "New Team", pt: "Novo Time" },
  ...
  create_capsule: { en: "Create your Team", pt: "Criar seu Time" },
  capsule_title: { en: "Create a Team — Shimpz", pt: "Criar um Time — Shimpz" },
  capsule_list_title: { en: "Your Teams — Shimpz", pt: "Seus Times — Shimpz" },
  capsule_list_kicker: { en: "Teams // isolated workspaces", pt: "Times // ambientes isolados" },
  capsule_list_lead: {
  ...
  capsule_count_label: { en: "Teams", pt: "Times" },
  capsule_actions: { en: "Team actions", pt: "Ações do Time" },
  ...
  capsule_name_label: { en: "Name your Team", pt: "Dê um nome ao seu Time" },
  capsule_name_ph: { en: "e.g. Marketing", pt: "ex.: Marketing" },
  capsule_submit: { en: "Create Team", pt: "Criar Time" },
  ...
  my_capsules: { en: "My Teams", pt: "Meus Times" },
  ...
  account_brains_lead: {
    en: "Seal one API key per provider for your Capsules.",
    pt: "Proteja uma chave de API por provedor para suas Cápsulas.",
  },
  ...
  brain_choose_provider_help: {
    en: "You can connect both, then choose a provider and model independently for each Capsule.",
    pt: "Você pode conectar ambos e escolher provedor e modelo de forma independente em cada Cápsula.",
  },
  brain_credential_title: { en: "Add the credential", pt: "Adicionar a credencial" },
  brain_credential_review: {
    en: "It is encrypted for your account and delivered in memory only while a matching Capsule turn runs.",
    pt: "Ela é cifrada para sua conta e entregue em memória apenas durante um turno de Cápsula compatível.",
  },
  ...
  brain_done_body: {
    en: "The API key was sealed successfully and is ready for matching Capsule turns.",
    pt: "A chave de API foi protegida e está pronta para turnos de Cápsulas compatíveis.",
  },
  ...
  login_lead: { en: "Log in to manage your Capsules and model providers.", pt: "Entre para gerenciar suas Cápsulas e provedores de modelo." },
  signup_lead: { en: "One account for your Capsules, providers and private chat.", pt: "Uma conta para suas Cápsulas, provedores e chat privado." },
  ...
  no_capsules: { en: "No Teams yet. Create one above.", pt: "Nenhum Time ainda. Crie um acima." },
  ...
  assistants_model_lead: {
    ...
    pt: "Cada Assistant vive dentro de uma Cápsula. Seu manifesto declara seus Powers, quais operações de Services pode solicitar e quais outros Assistants pode chamar.",
  },
  ...
  chat_lead: {
    en: "Talk naturally to your Team. Its Brain can coordinate every installed Assistant while each declared Power remains inside its security boundary.",
    pt: "Converse naturalmente com seu Time. O Cérebro pode coordenar todos os Assistants instalados, mantendo cada Power declarado dentro do seu limite de segurança.",
  },
  chat_capsule_title: { en: "Team context", pt: "Contexto do Time" },
  chat_capsule_help: {
  ...
  chat_brain_help: {
    en: "The Brain answers as your Team and coordinates only the Rules and Powers of its installed Assistants.",
    pt: "O Cérebro responde como seu Time e coordena somente os Rules e Powers dos Assistants instalados.",
  },
  ...
  brain_switch_hint: {
    en: "Provider and model changes apply to future turns without recreating the Team or its Assistants.",
    pt: "Alterações de provedor e modelo valem nos próximos turnos sem recriar o Time ou seus Assistants.",
  },
  ...
  chat_assistants_help: {
    en: "Installed Assistants are this Team's capabilities. The Brain chooses among their declared Powers when your request needs them.",
    pt: "Os Assistants instalados são as capacidades deste Time. O Cérebro escolhe entre seus Powers declarados quando sua solicitação precisar deles.",
  },
  chat_local_assistant_boundary: {
    en: "Browse the canonical Store to install or remove an Assistant from this hosted Team.",
    pt: "Acesse a loja canônica para instalar ou remover um Assistant deste Time hospedado.",
  },
  ...
  chat_powers: { en: "Available Powers", pt: "Powers disponíveis" },
  ...
  chat_storage_help: {
    en: "Opaque Team storage. Files are never executable or mounted into a Brain or Assistant; a declared Power must request access.",
    pt: "Storage opaco do Time. Arquivos nunca são executáveis nem montados em um Cérebro ou Assistant; um Power declarado precisa solicitar acesso.",
  },
  ...
  chat_empty: {
    en: "Start with a goal or question for your Team. Stored files remain private until a Power explicitly uses one.",
    pt: "Comece com um objetivo ou pergunta para seu Time. Arquivos armazenados permanecem privados até um Power usar um deles explicitamente.",
  },
  chat_login: { en: "Log in to open the bridge →", pt: "Entre para assumir o comando →" },
  chat_no_capsule: { en: "Create a Team first →", pt: "Crie um Time antes →" },
  ...
  crew_title: { en: "Team capabilities", pt: "Capacidades do Time" },
  crew_empty: { en: "No Assistants installed yet.", pt: "Nenhum Assistant instalado ainda." },
