...
const D: Dict = {
  ...
  chat_lead: {
    en: "Choose a Capsule, connect its Brain and work with every Assistant available inside its isolated boundary.",
    pt: "Escolha uma Cápsula, conecte seu Cérebro e trabalhe com todos os Assistants disponíveis dentro do limite isolado.",
  },
  ...
  chat_brain_help: {
    en: "The Brain runs the conversation and coordinates installed Assistants.",
    pt: "O Cérebro conduz a conversa e coordena os Assistants instalados.",
  },
  ...
  chat_assistants_help: {
    en: "The Brain can coordinate these Assistants inside this Capsule.",
    pt: "O Cérebro pode coordenar estes Assistants dentro desta Cápsula.",
  },
  ...
  chat_empty: {
    en: "Start with a goal, a question or a file. Your Capsule Brain will coordinate the work here.",
    pt: "Comece com um objetivo, uma pergunta ou um arquivo. O Cérebro da Cápsula coordena o trabalho aqui.",
  },
