...
COPY backend/app/__init__.py backend/app/authn.py backend/app/chat_ws_common.py backend/app/concurrency.py backend/app/config.py backend/app/logconf.py backend/app/main.py backend/app/model_catalog.json \
